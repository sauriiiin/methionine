...
data$attempt <- factor(data$attempt, levels = c('pilot', 'attempt1', 'attempt2'))
...
anova.res$attempt <- factor(anova.res$attempt, levels = c('pilot', 'attempt1', 'attempt2'))
...
effsize.res$attempt <- factor(effsize.res$attempt, levels = c('pilot', 'attempt1', 'attempt2'))
